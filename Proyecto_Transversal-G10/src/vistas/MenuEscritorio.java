...
public class MenuEscritorio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JMmostrarMaterias = new javax.swing.JMenuItem();
        jMMostrarAlporMateria = new javax.swing.JMenuItem();

        jMenuItem3.setText("jMenuItem3");

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jEscritorio.setBackground(new java.awt.Color(0, 153, 153));
        ...
        JMmostrarMaterias.setText("Mostrar materias");
        JMmostrarMaterias.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JMmostrarMateriasActionPerformed(evt);
            }
        });
        jMenu3.add(JMmostrarMaterias);

        jMMostrarAlporMateria.setText("Mostrar alumnos por materia");
        jMMostrarAlporMateria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMMostrarAlporMateriaActionPerformed(evt);
            }
        });
        jMenu3.add(jMMostrarAlporMateria);
...
System.exit(0);
    ...
    private void JMmostrarMateriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMmostrarMateriasActionPerformed
        jEscritorio.removeAll();
        jEscritorio.repaint();
        MostrarMaterias gm = new MostrarMaterias();
        gm.setVisible(true);
        jEscritorio.add(gm);
        jEscritorio.moveToFront(gm);
        
        
    }//GEN-LAST:event_JMmostrarMateriasActionPerformed
    ...
    private void jMModificarMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMModificarMateriaActionPerformed
         jEscritorio.removeAll();
        jEscritorio.repaint();
        GestionarMateria gm = new GestionarMateria();
        gm.setVisible(true);
        jEscritorio.add(gm);
        jEscritorio.moveToFront(gm);
    }//GEN-LAST:event_jMModificarMateriaActionPerformed

    private void jMMostrarAlporMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMMostrarAlporMateriaActionPerformed
        jEscritorio.removeAll();
        jEscritorio.repaint();
        MostrarMateriasPorAlumno gm = new MostrarMateriasPorAlumno();
        gm.setVisible(true);
        jEscritorio.add(gm);
        jEscritorio.moveToFront(gm);

    }//GEN-LAST:event_jMMostrarAlporMateriaActionPerformed
...
//    }
    ...
    private javax.swing.JMenuItem JMmostrarMaterias;
    ...
    private javax.swing.JMenuItem jMMostrarAlporMateria;
