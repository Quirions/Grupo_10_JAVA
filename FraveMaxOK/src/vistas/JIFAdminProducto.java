...
//                Cliente c = (Cliente) cd.obtenerUno(Integer.parseInt(jTID.getText()));
//                c.setNombre(jTDescripcion.getText());
//                c.setApellido(jTPrecioActual.getText());
//                c.setDni(Integer.parseInt(jTStock.getText()));
...
//        }else{
//            jTDescripcion.setText(c.getNombre());jTDescripcion.setEditable(true);
//            jTPrecioActual.setText(c.getApellido()); jTPrecioActual.setEditable(true);
